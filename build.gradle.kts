...
kotlin {
    ...
    val xcf = XCFramework("SimdAlphatensor")

    macosArm64 {
        binaries.framework { baseName = "SimdAlphatensor"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "SimdAlphatensor"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "SimdAlphatensor"
        flattenPackage = "com.kotlinmania.simd"
    }

    android {
        namespace = "com.kotlinmania.simd"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "simd-alphatensor-kotlin", version.toString())

    pom {
        name.set("simd-alphatensor-kotlin")
        description.set("Kotlin Multiplatform port of drbh/simd-alphatensor-rs - AlphaTensor matrix multiplication algorithms")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/simd-alphatensor-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/simd-alphatensor-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/simd-alphatensor-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/simd-alphatensor-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleSimdAlphatensorXCFramework",
    "assembleSimdAlphatensorDebugXCFramework",
    "assembleSimdAlphatensorReleaseXCFramework",
    "assembleDebugIosFatFrameworkForSimdAlphatensorXCFramework",
    "assembleReleaseIosFatFrameworkForSimdAlphatensorXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForSimdAlphatensorXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForSimdAlphatensorXCFramework",
    "assembleDebugMacosFatFrameworkForSimdAlphatensorXCFramework",
    "assembleReleaseMacosFatFrameworkForSimdAlphatensorXCFramework",
    "assembleDebugTvosFatFrameworkForSimdAlphatensorXCFramework",
    "assembleReleaseTvosFatFrameworkForSimdAlphatensorXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForSimdAlphatensorXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForSimdAlphatensorXCFramework",
    "assembleDebugWatchosFatFrameworkForSimdAlphatensorXCFramework",
    "assembleReleaseWatchosFatFrameworkForSimdAlphatensorXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForSimdAlphatensorXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForSimdAlphatensorXCFramework",
