# Agent guide - simd-alphatensor-kotlin

This file is the quick-reference operating contract for simd-alphatensor-kotlin. The longer
...
simd-alphatensor-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`simd-alphatensor`](./README.md). Upstream Rust is the behavioral oracle while the
