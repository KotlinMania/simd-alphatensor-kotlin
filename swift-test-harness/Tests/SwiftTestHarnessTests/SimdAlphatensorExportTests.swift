...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `SimdAlphatensor.swiftmodule/`
...
//      `import SimdAlphatensor` above would fail at compile time.
//
//   2. The static archive `libSimdAlphatensor.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "SimdAlphatensor" }` and
//      `flattenPackage = "com.kotlinmania.simd"` configuration in
...
//      via the `SimdAlphatensorLibrary` product.
//
